    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h3 class="font-bold text-gray-800 dark:text-white">Remover Investimento</h3>
            <button
              type="button"
          ...
          <div class="p-4 overflow-y-auto">
            <p class="mt-1 text-gray-800 dark:text-gray-400">
              Deseja remover o investimento <span class="investment-name font-semibold"></span>?
            </p>
          </div>
          <div
          ...
          >
            ...
            <button
              type="button"
              class="remove-investment-btn py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
              data-hs-overlay="#hs-basic-modal"
            >
              Confirmar
            </button>
